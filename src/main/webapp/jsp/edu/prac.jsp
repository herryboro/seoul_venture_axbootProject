...
<ax:layout name="base">
    <jsp:attribute name="script">
        <script type="text/javascript" src="<c:url value='/assets/js/view/edu/prac.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <ax:td label='회사명' width="300px">
                            <input type="text" class="js-compnayNm form-control" />
                        </ax:td>
                        <ax:td label='CEO' width="300px">
                            <input type="text" class="js-ceo form-control" />
                        </ax:td>
                        <ax:td label='법인 번호' width="300px">
