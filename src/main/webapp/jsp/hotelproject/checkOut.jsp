    ...
    <jsp:body>
        <div data-page-buttons>
            <div class="button-warp">
                ...
                <button type="button" class="btn btn-info" data-page-btn="reload">검색선택초기화</button>
                ...
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    ...
                    <ax:tr>
                        <ax:td label="객실타입" width="30%">
                            <ax:common-code groupCd="ROOM_TYPE" name="roomTypCd" dataPath="roomTypCd" clazz="js-roomTypCd form-control W100" emptyText="전체" />
                        </ax:td>
