    ...
    <jsp:body>
        ...
        <div data-page-buttons>
            <div class="button-warp">
                <button type="button" class="btn btn-info js-checkOut" data-page-btn="checkOut" value="체크아웃"><i class="fas fa-search"></i> 체크아웃</button>
                <button type="button" class="btn btn-info js-checkInCancel" data-page-btn="checkInCancel" value="체크인취소">체크인 취소</button>
                <button type="button" class="btn btn-info" data-page-btn="close"><i class="far fa-file-excel"></i> 닫기</button>
            </div>
        </div>
    </div>
</div>
