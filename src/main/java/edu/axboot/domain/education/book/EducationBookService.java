...
public class EducationBookService extends BaseService<EducationBook, Long> {
    private static final Logger logger = LoggerFactory.getLogger(EducationBookService.class);
    ...
    public List<EducationBook> totalList(EducationResponseDto educationResponseDto) {
        String companyNm = educationResponseDto.getCompanyNm();
        String ceo = educationResponseDto.getCeo();
        String bizno = educationResponseDto.getBizno();
        String useYn = educationResponseDto.getUseYn();
